...
struct DetailsView: View {
    ...
    var body: some View {
        LazyPop(
            rootView: Text(item.0 % 2 == 0 ? "Lazy pop enabled. Swipe anywhere to dimiss." : "Default behavior enabled. Swipe from the leftmost part of the screen to dismiss."),
            lazyPopEnabled: item.0 % 2 == 0
        )
